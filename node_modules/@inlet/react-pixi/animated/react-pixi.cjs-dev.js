...
unwrapExports(cjs);
cjs.removeFluidObserver;
cjs.addFluidObserver;
cjs.setFluidGetter;
cjs.callFluidObservers;
cjs.callFluidObserver;
cjs.getFluidObservers;
cjs.getFluidValue;
cjs.hasFluidValue;
cjs.FluidValue;
...
const assign = (globals) => {
  ...
  if (globals.requestAnimationFrame)
    raf_1.raf.use(globals.requestAnimationFrame);
  if (globals.batchedUpdates)
    raf_1.raf.batchedUpdates = globals.batchedUpdates;
...
const frameLoop = {
  ...
  start(animation) {
    if (priority > animation.priority) {
      ...
      raf_1.raf.onStart(flushStartQueue);
    } else {
  ...
  sort(animation) {
    if (priority) {
      raf_1.raf.onFrame(() => frameLoop.sort(animation));
    } else {
...
const createStringInterpolator$1 = (config) => {
  ...
  const output = config.output.map((value) => cjs.getFluidValue(value).replace(colorRegex, colorToRgba).replace(namedColorRegex, colorToRgba));
...
Object.keys(cjs).forEach(function (k) {
...
index_cjs$1.Globals;
index_cjs$1.colorToRgba;
index_cjs$1.colors;
index_cjs$1.createInterpolator;
index_cjs$1.createStringInterpolator;
index_cjs$1.defineHidden;
index_cjs$1.deprecateInterpolate;
index_cjs$1.each;
index_cjs$1.eachProp;
index_cjs$1.flush;
index_cjs$1.flushCalls;
index_cjs$1.frameLoop;
index_cjs$1.hex3;
index_cjs$1.hex4;
index_cjs$1.hex6;
index_cjs$1.hex8;
...
index_cjs$1.hsla;
index_cjs$1.is;
index_cjs$1.isAnimatedString;
index_cjs$1.isEqual;
index_cjs$1.noop;
index_cjs$1.rgb;
index_cjs$1.rgba;
index_cjs$1.toArray;
index_cjs$1.useForceUpdate;
index_cjs$1.useMemoOne;
index_cjs$1.useOnce;
index_cjs$1.usePrev;
...
const setAnimated = (owner, node) => index_cjs$1.defineHidden(owner, $node, node);
...
class AnimatedValue extends Animated {
  constructor(_value) {
    ...
    this._value = _value;
    this.done = true;
    if (index_cjs$1.is.num(this._value)) {
...
class AnimatedString extends AnimatedValue {
  constructor(value) {
    super(0);
    this._string = null;
    this._toString = index_cjs$1.createInterpolator({
      output: [value, value]
    });
  }
  static create(value) {
...
class AnimatedObject extends Animated {
  ...
  getValue(animated) {
    const values = {};
    index_cjs$1.eachProp(this.source, (source, key) => {
      if (isAnimated(source)) {
        values[key] = source.getValue(animated);
      } else if (index_cjs$1.hasFluidValue(source)) {
        values[key] = index_cjs$1.getFluidValue(source);
      } else if (!animated) {
        values[key] = source;
      }
    });
  ...
  reset() {
    if (this.payload) {
      index_cjs$1.each(this.payload, (node) => node.reset());
    }
  }
  _makePayload(source) {
    if (source) {
      const payload = new Set();
      index_cjs$1.eachProp(source, this._addToPayload, payload);
      return Array.from(payload);
    }
  }
  _addToPayload(source) {
    if (TreeContext.dependencies && index_cjs$1.hasFluidValue(source)) {
      TreeContext.dependencies.add(source);
    }
    const payload = getPayload(source);
    if (payload) {
      index_cjs$1.each(payload, (node) => this.add(node));
    }
  }
}
...
function makeAnimated(value) {
  const nodeType = index_cjs$1.isAnimatedString(value) ? AnimatedString : AnimatedValue;
  return nodeType.create(value);
}

function getAnimatedType(value) {
  const parentNode = getAnimated(value);
  return parentNode ? parentNode.constructor : index_cjs$1.is.arr(value) ? AnimatedArray : index_cjs$1.isAnimatedString(value) ? AnimatedString : AnimatedValue;
}

const withAnimated = (Component, host) => {
  const hasInstance = !index_cjs$1.is.fun(Component) || Component.prototype && Component.prototype.isReactComponent;
  return React__default['default'].forwardRef((givenProps, givenRef) => {
    ...
    const forceUpdate = index_cjs$1.useForceUpdate();
    const callback = () => {
    ...
    useLayoutEffect.useLayoutEffect(() => {
      ...
      index_cjs$1.each(deps, (dep) => index_cjs$1.addFluidObserver(dep, observer));
      if (lastObserver) {
        index_cjs$1.each(lastObserver.deps, (dep) => index_cjs$1.removeFluidObserver(dep, lastObserver));
        index_cjs$1.raf.cancel(lastObserver.update);
      }
    });
    React__default['default'].useEffect(callback, []);
    index_cjs$1.useOnce(() => () => {
      const observer2 = observerRef.current;
      index_cjs$1.each(observer2.deps, (dep) => index_cjs$1.removeFluidObserver(dep, observer2));
    });
...
class PropsObserver {
  ...
  eventObserved(event) {
    if (event.type == "change") {
      index_cjs$1.raf.write(this.update);
    }
  }
}
...
const createHost = (components, {
  ...
  const animated = (Component) => {
    ...
    if (index_cjs$1.is.str(Component)) {
  ...
  index_cjs$1.eachProp(components, (Component, key) => {
    if (index_cjs$1.is.arr(components)) {
...
const getDisplayName = (arg) => index_cjs$1.is.str(arg) ? arg : arg && index_cjs$1.is.str(arg.displayName) ? arg.displayName : index_cjs$1.is.fun(arg) && arg.name || null;
...
var index_cjs_6 = index_cjs.createHost;
index_cjs.getAnimated;
index_cjs.getAnimatedType;
...
var host = index_cjs_6(primitives, {
